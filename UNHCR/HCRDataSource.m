...
+ (NSArray *)globalAllBulletinsData {
    return @[
             @{@"Emergency": @YES,
               ...
               @"Category": @"Fire",
               @"Camp": @"Domiz, Iraq",
               @"Location": @"Phase 4, Row 5",
               @"Deaths": @"20",
               @"Hurt": @"100",
               @"Contact": @{@"Name": @"Farhad Ismael",
                             @"Email": @"farhadI@unhcr.org"}},
             @{@"Country": @"Iraq",
               @"Camp": @"Domiz",
               @"Cluster": @"Protection",
             ...
             @{@"Emergency": @YES,
               ...
               @"Category": @"Outbreak",
               @"Camp": @"Domiz, Iraq",
               @"Location": @"Phase 6, Row 2",
               @"Deaths": @"2",
               @"Hurt": @"10",
               @"Contact": @{@"Name": @"Tankred Stoebe",
                             @"Email": @"stoebe@msf.org"},
               @"Status": @"Quarantine in progress. Isolation and shelter-in-place in all camp phases initiated.",
               @"Needs": @"We need additional medication, including DOTS"},
             @{@"Country": @"Iraq",
               @"Camp": @"Domiz",
               @"Cluster": @"Nutrition",
             ...
             @{@"Emergency": @YES,
               ...
               @"Camp": @"Domiz, Iraq",
               @"Location": @"Reports differ",
               @"Deaths": @"2",
               @"Hurt": @"35",
               @"Contact": @{@"Name": @"Mohammad Jasser",
                             @"Email": @"mjasser@who.org"},
               @"Status": @"Military enroute.  Multiple gunmen reported.",
               @"Needs": @"We need additional military and police support ASAP."},
             @{@"Country": @"Iraq",
               @"Camp": @"Domiz",
               @"Cluster": @"Education",
